      ...
      <div className="flex flex-col items-center justify-center flex-1 px-6 py-10">
        ...
        >
          ...
          <div className="bg-[#1C1C1E] border border-[#252528] rounded-3xl p-6">
            <h2 className="text-xl font-bold mb-0.5">Create account</h2>
            <p className="text-[#9A9AAA] text-sm mb-6">Start crushing your goals today</p>
          ...
          <p className="text-center text-sm text-[#9A9AAA] mt-5">
            ...
            <Link href="/login" className="text-[#FF4500] font-semibold hover:text-[#FF6020] transition-colors">
              Sign in
            </Link>
          </p>
        </motion.div>
